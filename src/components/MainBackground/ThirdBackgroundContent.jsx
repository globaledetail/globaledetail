                        ...
                        <SwiperSlide>
                            ...
                            <div className="slide-container">
                                <a href="https://n.news.naver.com/article/018/0004271926" target='_blank'> 
                                    <img src={ process.env.PUBLIC_URL + "/img/news/news3.png"} alt="news"/> 
                                </a>
                            </div>
                            <a href="https://n.news.naver.com/article/018/0004271926" target='_blank'>  
                        ...
                        <SwiperSlide>
                            ...
                            <div className="slide-container">
                                <a href="https://www.gukjenews.com/news/articleView.html?idxno=2599665" target='_blank'> 
                                    <img src={ process.env.PUBLIC_URL + "/img/awards/award1.png"} alt="news"/> 
                                </a>
                            </div>
                            <a href="https://www.gukjenews.com/news/articleView.html?idxno=2599665" target='_blank'>  
                        ...
                        <SwiperSlide>
                            ...
                            <div className="slide-container">
                                <a href="https://it.chosun.com/news/articleView.html?idxno=2019032201667" target='_blank'> 
                                    <img src={ process.env.PUBLIC_URL + "/img/news/news5.jpg"} alt="news"/> 
                                </a>
                            </div>
                            <a href="https://it.chosun.com/news/articleView.html?idxno=2019032201667" target='_blank'>  
                        ...
                        <SwiperSlide>
                            ...
                            <div className="slide-container">
                                <a href="https://www.etnews.com/20191213000205" target='_blank'> 
                                    <img src={ process.env.PUBLIC_URL + "/img/news/news6.jpg"} alt="news"/> 
                                </a>
                            </div>
                            <a href="https://www.etnews.com/20191213000205" target='_blank'>  
